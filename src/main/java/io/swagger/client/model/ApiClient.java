    ...
    public RequestBody buildRequestBodyMultipart(Map<String, Object> formParams) throws IOException {
        ...
        for (Entry<String, Object> param : formParams.entrySet()) {
            if (param.getValue() instanceof File) {
                ...
                Headers partHeaders = Headers.of("Content-Disposition",
                        "form-data; name=\"" + param.getKey() + "\"; filename=\"" + formParams.get("File-Name").toString() + "\"");
                MediaType mediaType = MediaType.parse(formParams.get("Mime-Type").toString());
                mpBuilder.addPart(partHeaders, RequestBody.create(mediaType, file.readAllBytes()));
            } else {
