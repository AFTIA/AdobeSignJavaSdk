...
public class AgreementCancellationInfo {
  ...
  /**
   * An optional comment describing to the recipients why you want to cancel the
   * transaction
   * 
   * @return comment
   **/
  ...
  /**
   * Whether or not you would like the recipients to be notified that the
   * transaction has been cancelled. The default value is false
   * 
   * @return notifyOthers
   **/
