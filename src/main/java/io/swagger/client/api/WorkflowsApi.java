...
public class WorkflowsApi {
     ...
     *                                 square&#39;&gt;&lt;a
     *                                 href&#x3D;\&quot;#\&quot;
     *                                 onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;workflow_read&#39;)\&quot;
     *                                 oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;workflow_read&#39;)\&quot;
     *                                 target&#x3D;\&quot;oauthDoc\&quot;&gt;workflow_read&lt;/a&gt;&lt;/li&gt;&lt;/ul&gt;in
     *                                 the format &lt;b&gt;&#39;Bearer
     ...
     * @param groupId                  The group identifier for which the workflows
     ...
     */
    public com.squareup.okhttp.Call getWorkflowsCall(String authorization, String xApiUser,
            Boolean includeDraftWorkflows, Boolean includeInactiveWorkflows, String groupId,
    ...
    private com.squareup.okhttp.Call getWorkflowsValidateBeforeCall(String authorization, String xApiUser,
            Boolean includeDraftWorkflows, Boolean includeInactiveWorkflows, String groupId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWorkflowsCall(authorization, xApiUser, includeDraftWorkflows,
                includeInactiveWorkflows, groupId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public UserWorkflows getWorkflows(String authorization, String xApiUser, Boolean includeDraftWorkflows,
            Boolean includeInactiveWorkflows, String groupId) throws ApiException {
        ApiResponse<UserWorkflows> resp = getWorkflowsWithHttpInfo(authorization, xApiUser, includeDraftWorkflows,
                includeInactiveWorkflows, groupId);
        return resp.getData();
    }
     ...
     *                      deserialize the response body
     */
    public ApiResponse<UserWorkflows> getWorkflowsWithHttpInfo(String authorization, String xApiUser,
            Boolean includeDraftWorkflows, Boolean includeInactiveWorkflows, String groupId) throws ApiException {
        com.squareup.okhttp.Call call = getWorkflowsValidateBeforeCall(authorization, xApiUser, includeDraftWorkflows,
                includeInactiveWorkflows, groupId, null, null);
        Type localVarReturnType = new TypeToken<UserWorkflows>() {
        }.getType();
     ...
     *                      request body object
     */
    public com.squareup.okhttp.Call getWorkflowsAsync(String authorization, String xApiUser,
            Boolean includeDraftWorkflows, Boolean includeInactiveWorkflows, String groupId,
            final ApiCallback<UserWorkflows> callback) throws ApiException {
