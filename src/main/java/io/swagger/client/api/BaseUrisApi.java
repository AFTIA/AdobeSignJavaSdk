...
public class BaseUrisApi {
     ...
     *                                Access Token&lt;/a&gt; with any of the valid
     *                                scopes&lt;ul&gt;&lt;/ul&gt;in the format
     ...
     */
    public com.squareup.okhttp.Call getBaseUrisCall(String authorization,
    ...
    private com.squareup.okhttp.Call getBaseUrisValidateBeforeCall(String authorization,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    /**
     * Gets the base uri to access other APIs. In case other APIs are accessed from
     * a different end point, it will be considered an invalid request.
     * 
     * @param authorization An &lt;a href&#x3D;\&quot;#\&quot;
     *                      onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
     *                      oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
     *                      target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access
     *                      Token&lt;/a&gt; with any of the valid
     *                      scopes&lt;ul&gt;&lt;/ul&gt;in the format
    ...
    public ApiResponse<BaseUriInfo> getBaseUrisWithHttpInfo(String authorization) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<BaseUriInfo>() {
        }.getType();
     ...
     *                      request body object
     */
    public com.squareup.okhttp.Call getBaseUrisAsync(String authorization, final ApiCallback<BaseUriInfo> callback)
            throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBaseUrisValidateBeforeCall(authorization, progressListener,
