...
public class TransientDocumentsApi {
     ...
     */
    public com.squareup.okhttp.Call createTransientDocumentCall(String authorization, File file, String xApiUser,
     ...
     */
    public TransientDocumentResponse createTransientDocument(String authorization, File file, String xApiUser,
    ...
    /**
     * Uploads a document and obtains the document&#39;s ID. (asynchronously) The
     * document uploaded through this call is referred to as transient since it is
     * available only for 7 days after the upload. The returned transient document
     * ID can be used in the API calls where the uploaded file needs to be referred.
     * The transient document request is a multipart request consisting of three
     * parts - filename, mime type and the file stream. You can only upload one file
     * at a time in this request.
     * 
     * @param authorization   An &lt;a href&#x3D;\&quot;#\&quot;
     *                        onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
     *                        oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
     ...
     *                      request body object
     */
    public com.squareup.okhttp.Call createTransientDocumentAsync(String authorization, File file, String xApiUser,
            String xOnBehalfOfUser, String fileName, String mimeType,
            final ApiCallback<TransientDocumentResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createTransientDocumentValidateBeforeCall(authorization, file, xApiUser,
                xOnBehalfOfUser, fileName, mimeType, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TransientDocumentResponse>() {
        }.getType();
